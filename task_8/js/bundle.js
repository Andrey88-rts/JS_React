...
function calc() {
  ...
  function getStaticField(selector, activeClass) {
    var elements = document.querySelectorAll(selector);
    elements.forEach(function (elem) {
  ...
  getStaticField("#gender div", "calculating__choose-item_active");
  getStaticField(".calculating__choose_big div", "calculating__choose-item_active");

  function getDynamicField(selector) {
  ...
  getDynamicField("#height");
  getDynamicField("#weight");
  getDynamicField("#age");
}
...
function cards() {
  //Использование класов для карточек меню
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (e) {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_9__.postData)("http://localhost:3000/requests", json).then(function (data) {
        ...
        return showThanksModal(message.failure);
      }).finally(function () {
        return form.reset();
      });
    });
  ...
  fetch("http://localhost:3000/menu").then(function (resolve) {
    return resolve.json();
  }).then(function (data) {
...
function openModal(modalSelector, modalTimerId) {
  var modal = document.querySelector(modalSelector);
  var scrollRight = window.innerWidth - document.querySelector("body").offsetWidth + "px";
...
function slider(_ref) {
  ...
  var arrowNext = document.querySelector(nextArrow);
  var arrowPrev = document.querySelector(prevArrow);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (tabs); // Syntax CommonJS
...
/* harmony import */ var _modules_modal_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/modal */ "./js/modules/modal.js");
/* harmony import */ var _modules_slider_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/slider.js */ "./js/modules/slider.js");
/* harmony import */ var _modules_timer_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/timer.js */ "./js/modules/timer.js");
...
window.addEventListener("DOMContentLoaded", function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_7__.openModal)(".modal", modalTimerId);
  }, 50000);
  (0,_modules_tabs_js__WEBPACK_IMPORTED_MODULE_3__.default)(".tabheader__item", ".tabcontent", ".tabheader__items", ".tabheader__item_active");
  ...
  (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_7__.default)("[data-modal]", ".modal", modalTimerId);
  (0,_modules_slider_js__WEBPACK_IMPORTED_MODULE_8__.default)({
  ...
  (0,_modules_timer_js__WEBPACK_IMPORTED_MODULE_9__.default)(".timer", "2020-12-12");
});

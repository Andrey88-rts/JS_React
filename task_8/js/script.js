window.addEventListener("DOMContentLoaded", () => {
    ...
    function getStaticField(parentSelector, activeClass) {
    ...
    getStaticField("#gender", "calculating__choose-item_active");
    getStaticField(".calculating__choose_big", "calculating__choose-item_active");
